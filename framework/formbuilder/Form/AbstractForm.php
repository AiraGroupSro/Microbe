...
use AiraGroupSro\Microbe\framework\formbuilder\Form\FormInterface;
use AiraGroupSro\Microbe\framework\validator\Validator;
				...
				if($attributes['type'] !== 'button'){
					if($attributes['type'] === 'entity'){
						...
						if($attributes['multiple'] === true){
							$values = [];
							if(is_countable($this->data[$field]) && count($this->data[$field]) > 0){
